...
Different regions hold different tensors (heterogeneous): uniform objects write their inverted 3×3 into their grid slice; multi-material objects/devices map a per-voxel material index into the ordered material list.
