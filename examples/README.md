...
- [`graded_grid_slab/`](graded_grid_slab/) — mesh override regions: a `GradedGrid` with a 12.5 nm `RefinementRegion` over a dielectric slab on a 50 nm background, against uniform coarse and uniform fine grids (transmission within 3.9e-4 of the fine answer at 220 z-cells instead of 320).
